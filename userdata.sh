...
CHEF_SERVER_NAME="jad-chef-automate" # The name of your Chef Server
CHEF_SERVER_ENDPOINT="jad-chef-automate-oydjsmg3ddo3wu0t.us-east-1.opsworks-cm.io" # The FQDN of your Chef Server
