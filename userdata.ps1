<powershell>
 ...
 $env:CHEF_SERVER_NAME = "jad-chef-automate" # Name of your Chef Server
 $env:CHEF_SERVER_ENDPOINT = "jad-chef-automate-oydjsmg3ddo3wu0t.us-east-1.opsworks-cm.io" # FQDN of your Chef Server
